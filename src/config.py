...
class Config:
    ...
    tickflow_api_key: Optional[str] = field(default_factory=lambda: os.getenv("TICKFLOW_API_KEY"))
    finnhub_api_key: Optional[str] = field(default_factory=lambda: os.getenv("FINNHUB_API_KEY"))

    # 通知
    wechat_webhook_url: Optional[str] = field(default_factory=lambda: os.getenv("WECHAT_WEBHOOK_URL"))
    feishu_webhook_url: Optional[str] = field(default_factory=lambda: os.getenv("FEISHU_WEBHOOK_URL"))
